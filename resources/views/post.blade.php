				...
				<div class="main-post">
					...
					<div class="post-icons-area">
						<ul class="post-icons">
							<li>
                                @guest
                                    <a href="javascript:void(0);" onclick="toastr.info('info', 'To add favorite list. You need to login first',{
                                         closeButton: true,
                                         progressBar: true,
                                    ...
                                    <li>
                                        ...
                                        @else
                                            <a href="javascript:void(0);" onclick="document.getElementById('favorite-form-{{ $randomPost->id }}').submit();" 
                                                class="{{ Auth::user()->favorite_posts->where('pivot.post_id',$randomPost->id)->count() == 0 ? '' : 'favorite-post' }}">
                                                <i class="ion-heart"></i>{{ $randomPost->favorite_to_users->count() }}</a>
