                                                ...
                                                <td>
                                                    <div class="media">
                                                        <div class="media-left">
                                                            <a href="#">
                                                                <img src="{{ asset('storage/profile') }}/{{ $comment->user->image }}" height="64" width="64">
                                                            </a>
                                                        </div>
                                                        <div class="media-body">
                                                            ...
                                                            <p>{{ $comment->comment }}</p>
                                                            <a href="{{ route('post.details', $comment->post->slug) }}">Replay</a>
                                                        </div>
                                                    </div>
                                                </td>
                                                    ...
                                                    <div class="media">
                                                        <div class="media-right">
                                                            <a href="{{ route('post.details', $comment->post->slug) }}">
                                                                <img src="{{ asset('storage/post') }}/{{ $comment->post->image }}" height="64" width="64">
                                                            </a>
                                                        </div>
                                                        <div class="media-body">
                                                            <a href="{{ route('post.details',$comment->post->slug) }}">
                                                                <h4>{{ Str::limit($comment->post->title,'40') }}</h4>
                                                            </a>
...
@push('js')
    ...
    <!-- Sweet Alert -->
    <script src="{{ asset('assets/backend/sweetalert/sweetalert2@9.js') }}"></script>
